  ...
  <tr style="border: none;">
    <td valign="top" style="border: none;">
      ...
      <ul>
        ...
        <li><strong>SmartThings Hub V2</strong> (or later) on the same LAN as the PlexAmp instance<sup>[1]</sup></li>
        <li><strong>Plex Media Server</strong> (assumed running on your LAN, port 32400)</li>
      </ul>
      <p><small>[1] should also work with Aeotec hubs, but has not been tested</small></p>
    </td>
